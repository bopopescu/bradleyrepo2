...
WRITEREPO = '''<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
        <addon id="repository.duckpool" name="DUCKPOOL Repository" version="10.3" provider-name="Mucky Duck">
            <extension point="xbmc.addon.repository" name="Mucky Duck">
		<info compressed="false">https://raw.githubusercontent.com/mucky-duck/duckpool/master/addons.xml</info>
		<checksum>https://raw.githubusercontent.com/mucky-duck/duckpool/master/addons.xml.md5</checksum>
		<datadir zip="true">https://raw.githubusercontent.com/mucky-duck/duckpool/master/zips/</datadir>
            </extension>
            <extension point="xbmc.addon.metadata">
		<summary>DUCKPOOL XBMC Addons and Extensions</summary>
		<description>DUCKPOOL XBMC Addons and Extensions</description>
...
if xbmc_version >= 16.9:
        dependencies = ['repository.duckpool', 'script.module.muckys.common', 'script.icechannel.theme.default', 'script.module.elementtree',
